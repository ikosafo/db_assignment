  ...
  <div class="card mb-0" id="error_loc">
    <div class="card-body">
      <a href="index.html" class="brand-logo">
        <!--  Logo here -->
        <h2 class="brand-text text-center text-primary ms-1 text-uppercase"><?php echo getCompanyName($conn); ?> <br /> <small>CUSTOMER ORDER ENTRY</small></h2>
      </a>
...
<script>
  $("#login-btn").click(function() {
    ...
    if (error == "") {
      $.ajax({
        type: "POST",
        url: "ajax/queries/action/login.php",
        beforeSend: function() {
          $.blockUI({
